...
Click on clusters to see individual site locations
...
addAwesomeMarkers(icon=icons, label=~names, clusterOptions = markerClusterOptions(iconCreateFunction=JS("function (cluster) {    
  ...
  }"))) %>% addLegend(title = "CO Level", labels = c("High (>1000 ug/m3)", "Medium (500-1000 ug/m3)", "Low (<500 ug/m3)"), colors = c("red", "orange", "green"))
```
