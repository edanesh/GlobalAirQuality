...
Here, I have used the OpenAQ air quality database in Google Cloud Platform (https://console.cloud.google.com/marketplace/details/openaq/real-time-air-quality?filter=solution-type:dataset&q=air%20quality&id=2e51036c-7370-4637-b87f-a001b591b991) to visualise pollution levels around the world. 
...
sites %>% leaflet() %>% addTiles() %>% addAwesomeMarkers(icon=icons, label=~names, clusterOptions = markerClusterOptions()) %>% addLegend(title = "CO Level", labels = c("High (>1000 ug/m3)", "Medium (500-1000 ug/m3)", "Low (<500 ug/m3)"), colors = c("red", "orange", "green"))
```
